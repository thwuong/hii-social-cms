    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-[2px] bg-white/10 border border-white/10 p-[1px]">
      {items.map((item) => {
        ...
        return (
          ...
          >
            {/* Hover Line */}
            <div className="absolute top-0 left-0 w-full h-[1px] bg-white transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left z-20" />
